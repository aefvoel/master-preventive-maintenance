...
import tiregdev.mpm.activity.DetailTeknisi;
...
public class TeknisiAdapter extends RecyclerView.Adapter<TeknisiAdapter.holder_teknisi> {
    private List<Teknisi> itemList;
    private Context context;
    Teknisi listPosition;

    public TeknisiAdapter(Context context, List<Teknisi> itemList){
        this.itemList = itemList;
        this.context = context;
    }

    @Override
    public TeknisiAdapter.holder_teknisi onCreateViewHolder(ViewGroup parent, int viewType){
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_teknisi,null);
        TeknisiAdapter.holder_teknisi hn = new holder_teknisi(layoutView);
        return hn;
    }


    @Override
    public void onBindViewHolder(TeknisiAdapter.holder_teknisi holder, int position){
        ...
        public holder_teknisi(View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i=new Intent(context,DetailTeknisi.class);
